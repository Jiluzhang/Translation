...
train_atac_file = "atac_32124_shuf_10000_2.h5ad"
train_rna_file = "rna_32124_shuf_10000_2.h5ad"
...
model.load_state_dict(torch.load('/fs/home/jiluzhang/scM2M_v2/models/32124_cells_epoch_1_iter_9399/pytorch_model.bin'))
...
plt.savefig('gene_attention_10000_datasets2.png')
plt.close()
...
plt.savefig('peak_attention_10000_datasets2.png')
plt.close()
...
plt.imshow(dec_attn['cross_attn']["attn"][0].to("cpu"), cmap='Reds',
...
plt.savefig('gene_peak_attention_10000_datasets2_3.png')
plt.close()
