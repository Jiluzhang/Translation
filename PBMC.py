...
accelerate launch --config_file accelerator_config.yaml --main_process_port 29822 rna2atac_evaluate.py \
                  -d ./preprocessed_data_val \
                  -l save/2024-06-19_rna2atac_train_60/pytorch_model.bin --config_file rna2atac_config_val_eval.yaml

accelerate launch --config_file accelerator_config.yaml --main_process_port 29822 rna2atac_evaluate.py \
                  -d ./preprocessed_data_test_2048 \
                  -l save/2024-06-19_rna2atac_train_60/pytorch_model.bin --config_file rna2atac_config_val_eval_2.yaml
...
accelerate launch --config_file accelerator_config.yaml --main_process_port 29822 rna2atac_evaluate.py -d ./preprocessed_data_test \
                  -l save/2024-06-15_rna2atac_train_29/pytorch_model.bin --config_file rna2atac_config_val_eval.yaml
